    ...
    var name,
        ...
        sources = {
          grammar: [
            ...
            '          throw new Error("Max recursion depth breached!");',
            '        }',
            '      }',
          ...
          rule: [
            ...
            '    console.log(Array(depth * tabspace).join(" ") + "Enter:" + "#{node.name}" + ":" + input.substr(pos.offset, 10));}',
            '  #end',
